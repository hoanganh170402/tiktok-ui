...
const CapCutIcon = ({ width = '1.8rem', height = '1.8rem', className, stylesIcon }) => (
    <svg
        fill="currentColor"
        fontSize="16"
        viewBox="0 0 48 48"
...
const HOCamera = ({ width = '1.8rem', height = '1.8rem', className, stylesIcon }) => (
    <svg
        width={width}
        height={height}
        viewBox="0 0 20 24"
...
const HOQuanlity = ({ width = '1.8rem', height = '1.8rem', className, stylesIcon }) => (
    ...
    >
        <path
            d="M2.875 4C1.83947 4 1 4.85626 1 5.9125V17.3875C1 18.4437 1.83947 19.3 2.875 19.3H17.125C18.1605 19.3 19 18.4437 19 17.3875V5.9125C19 4.85626 18.1605 4 17.125 4H2.875Z"
            fill="black"
        />
        <path
            d="M5.27249 13.6516C4.97965 13.6516 4.78366 13.4429 4.78366 13.1196V10.8391H4.76521L4.41242 11.1089C4.32941 11.1725 4.27638 11.1929 4.18414 11.1929C4.00198 11.1929 3.86133 11.0427 3.86133 10.8289C3.86133 10.6788 3.91667 10.5566 4.04579 10.4599L4.64992 10.0145C4.84361 9.87192 5.01193 9.85156 5.20101 9.85156C5.5538 9.85156 5.76133 10.0857 5.76133 10.4548V13.1196C5.76133 13.4429 5.56533 13.6516 5.27249 13.6516Z"
            fill="white"
        />
        <path
            d="M7.9471 13.6516C7.07289 13.6516 6.521 12.9335 6.521 11.7441C6.521 10.5472 7.07952 9.85156 7.9471 9.85156C8.81468 9.85156 9.371 10.5447 9.371 11.7416C9.371 12.9285 8.82131 13.6516 7.9471 13.6516ZM7.9471 12.8387C8.23409 12.8387 8.41732 12.4971 8.41732 11.7441C8.41732 10.9886 8.23409 10.6644 7.9471 10.6644C7.66011 10.6644 7.47468 10.9886 7.47468 11.7441C7.47468 12.4971 7.66011 12.8387 7.9471 12.8387Z"
            fill="white"
        />
        <path
            d="M11.5548 13.6516C10.7061 13.6516 10.1309 13.2224 10.1309 12.5762C10.1309 12.0772 10.4725 11.7478 10.931 11.6655V11.6455C10.532 11.5582 10.2455 11.2488 10.2455 10.8446C10.2455 10.2682 10.7745 9.85156 11.5548 9.85156C12.335 9.85156 12.864 10.2682 12.864 10.8471C12.864 11.2438 12.5775 11.5582 12.1829 11.6455V11.6655C12.6414 11.7478 12.9809 12.0797 12.9809 12.5787C12.9809 13.2224 12.399 13.6516 11.5548 13.6516ZM11.5548 11.3586C11.7796 11.3586 11.9427 11.1939 11.9427 10.9544C11.9427 10.7149 11.7774 10.5527 11.5548 10.5527C11.3321 10.5527 11.169 10.7149 11.169 10.9544C11.169 11.1939 11.3299 11.3586 11.5548 11.3586ZM11.5548 12.948C11.8171 12.948 11.9934 12.7583 11.9934 12.4988C11.9934 12.2443 11.8171 12.0597 11.5548 12.0597C11.2925 12.0597 11.1161 12.2443 11.1161 12.4988C11.1161 12.7583 11.2925 12.948 11.5548 12.948Z"
            fill="white"
        />
        <path
            d="M15.1668 13.6516C14.2926 13.6516 13.7407 12.9335 13.7407 11.7441C13.7407 10.5472 14.2992 9.85156 15.1668 9.85156C16.0344 9.85156 16.5907 10.5447 16.5907 11.7416C16.5907 12.9285 16.041 13.6516 15.1668 13.6516ZM15.1668 12.8387C15.4538 12.8387 15.637 12.4971 15.637 11.7441C15.637 10.9886 15.4538 10.6644 15.1668 10.6644C14.8798 10.6644 14.6944 10.9886 14.6944 11.7441C14.6944 12.4971 14.8798 12.8387 15.1668 12.8387Z"
            fill="white"
        />
    </svg>
);

const HOidea = ({ width = '1.8rem', height = '1.8rem', className, stylesIcon }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={width}
        height={height}
...
const IMGUpload = ({ width = '7.2rem', height = '7.2rem', className, stylesIcon }) => (
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M29.3475 7.44071L8.80642 11.8069C3.94448 12.8403 0.840862 17.6194 1.8743 22.4814L9.98285 60.6291C11.0163 65.4911 15.7954 68.5947 20.6574 67.5613L40.8309 63.2732C39.7536 62.2417 38.7029 60.5725 38.7029 58.3511C38.7029 56.0547 39.8258 54.3483 40.9405 53.3263C41.9125 52.4351 42.9629 51.9632 43.5699 51.7215C44.6435 51.2941 45.945 50.9911 46.7678 50.7995L47.0111 50.7427C47.2624 50.6835 47.4969 50.6274 47.7167 50.5732L40.0221 14.3728C38.9886 9.51089 34.2095 6.40727 29.3475 7.44071ZM33.4369 34.6157C34.9743 35.1152 35.3945 37.0918 34.1931 38.1735L23.1879 48.0827C21.9865 49.1644 20.0647 48.5399 19.7286 46.9587L16.6496 32.4733C16.3135 30.892 17.8152 29.5399 19.3526 30.0394L33.4369 34.6157Z"
            fill="url(#paint0_linear_803_20140)"
        />
        <path
            d="M68.9757 32.4262L63.7829 41.4205C63.6584 41.2592 63.5236 41.0977 63.3774 40.9383C62.5048 39.9867 61.1329 39.0287 59.3205 38.7694L62.5713 20.3337C62.6841 19.6936 62.7364 19.0568 62.7323 18.4293L65.6815 20.132C69.9861 22.6173 71.461 28.1216 68.9757 32.4262Z"
            fill="url(#paint1_linear_803_20140)"
        />
        <path
            d="M57.6185 22.5066L54.5558 39.876C54.0748 40.2042 53.6644 40.5719 53.3282 40.9386C52.437 41.9107 51.965 42.961 51.7233 43.568C51.5133 44.0955 51.3333 44.6781 51.1819 45.2318L44.4237 13.4372C44.2351 12.55 43.9634 11.7019 43.6185 10.8992L50.3181 12.0805C55.2131 12.9437 58.4817 17.6116 57.6185 22.5066Z"
            fill="url(#paint2_linear_803_20140)"
        />
        <path
            d="M57.6173 22.5059L54.5546 39.8752C54.0735 40.2035 53.6632 40.5711 53.3269 40.9379C52.4357 41.9099 51.9638 42.9603 51.7221 43.5673C51.5121 44.0948 51.3321 44.6773 51.1806 45.231L44.4225 13.4365C44.2339 12.5493 43.9622 11.7011 43.6172 10.8984L50.3168 12.0798C55.2119 12.9429 58.4804 17.6108 57.6173 22.5059Z"
            fill="url(#paint3_linear_803_20140)"
        />
        <path
            d="M68.9755 32.4266L63.7826 41.4209C63.6582 41.2596 63.5233 41.0981 63.3772 40.9387C62.5045 39.9871 61.1327 39.0291 59.3203 38.7698L62.571 20.3341C62.6839 19.694 62.7362 19.0572 62.7321 18.4297L65.6812 20.1324C69.9859 22.6177 71.4608 28.122 68.9755 32.4266Z"
            fill="url(#paint4_linear_803_20140)"
        />
        <circle cx="53.25" cy="53.25" r="18.75" fill="#F7F7F7" />
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M50.8015 42.0039C52.0613 40.6654 54.1887 40.6654 55.4485 42.0039L64.7297 51.8651C65.4543 52.6351 65.4176 53.8467 64.6476 54.5713C63.8777 55.296 62.6661 55.2593 61.9414 54.4893L55.0395 47.156V64.4733C55.0395 65.5306 54.1823 66.3878 53.125 66.3878C52.0677 66.3878 51.2105 65.5306 51.2105 64.4733V47.156L44.3086 54.4893C43.5839 55.2593 42.3723 55.296 41.6024 54.5713C40.8324 53.8467 40.7957 52.6351 41.5204 51.8651L50.8015 42.0039Z"
            fill="url(#paint5_linear_803_20140)"
        />
        <defs>
            <linearGradient
                id="paint0_linear_803_20140"
                x1="41.25"
                y1="67.5"
                x2="41.25"
                y2="0.749999"
